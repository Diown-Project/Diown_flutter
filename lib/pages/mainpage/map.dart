...
>>>>>>> Stashed changes
  ...
  static const double fabHeightClosed = 175.0;
          ...
          body: Stack(
            ...
            children: [SlidingUpPanel(
              ...
              panelBuilder: (controller) =>
                  selectMarker
                  ? makerPanelWidget(controller, panelController)
                  : panelWidget(controller, panelController),
              borderRadius: const BorderRadius.vertical(top: Radius.circular(10)),
              onPanelSlide: (position) {
                selectMarker
                ? setState(() {
                    final panelMaxScrollExtent = MediaQuery.of(context).size.height * 0.7 - MediaQuery.of(context).size.height * 0.21;
...
=======
  ...
  Widget makerPanelWidget(ScrollController controller, PanelController panelController) {
    return Scaffold(
  ...
  Widget buildPinDetail() {
    return Container(
      ...
      child: Column(
        ...
        children:[
          Text(
            'Select location on map to put down your diary',
            style: TextStyle(
              color: Colors.grey
            ),
          ),
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: const Icon(MdiIcons.mapMarkerPlus, color: Color(0xff8b82ff)),
                      ),
                      const Text('add new\npin location')
                    ],
                  ),
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: const Icon(MdiIcons.bookMarker, color: Color(0xff8b82ff)),
                      ),
                      const Text('your own\npin location')
                    ],
                  ),
